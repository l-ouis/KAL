...
with open('test_input_ids.pkl', 'rb') as f:
...
# harmon.dump_midi("test_output.mid")


# # Load the MIDI files
# input_stream = converter.parse("test_input.mid")
# output_stream = converter.parse("test_output.mid")
...
# combined_stream.write('midi', fp='combined_test.mid')
