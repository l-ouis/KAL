...
class AttentionMatrix(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        X = tf.random.normal(shape = Q.shape, mean = 0, stddev = 1)
        relative_positional_encoding = tf.matmul(X, positional_embedding_transposed)
        ...
        # relative positional: 
        # return tf.add(attention_weights, rpe_final) 
